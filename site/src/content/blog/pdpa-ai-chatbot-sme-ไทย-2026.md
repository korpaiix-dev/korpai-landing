...
- [AI Chatbot ร้านขายยา / เภสัช / Online Pharmacy SME ไทย 2026 — case study + compliance pack](/blog/ai-chatbot-ร้านขายยา-เภสัช-pharmacy-sme-2026)
...
### Vertical ที่ต้องระวัง PDPA เป็นพิเศษ (สำหรับ "special category data")

ธุรกิจที่ถาม "ข้อมูลสุขภาพ" หรือข้อมูลอ่อนไหวอื่น ๆ ต้องมี explicit consent แยก ไม่สามารถใช้ consent ทั่วไปได้ ตัวอย่าง vertical ที่ KORP AI ทำคู่มือเฉพาะให้แล้ว:
- [AI Chatbot ตัวแทน/โบรกเกอร์ประกัน — guardrail OIC + PDPA special category](/blog/ai-chatbot-ตัวแทนประกัน-โบรกเกอร์-insurance-sme-2026) (สอบถามสุขภาพ + เลขบัตรประชาชน + เลขใบขับขี่)
- [AI Chatbot คลินิกทันตกรรม — X-ray + ประวัติการรักษา](/blog/ai-chatbot-คลินิกทันตกรรม-dental-sme-2026)
- [AI Chatbot คลินิกศัลยกรรม/คลินิกความงาม SME 2026 — before/after consent + อย. guardrail](/blog/ai-chatbot-คลินิกศัลยกรรม-aesthetic-clinic-sme-2026)
- [AI Chatbot สำหรับสำนักงานบัญชี — PDPA financial vault per-client + audit trail ม.30](/blog/ai-chatbot-สำนักงานบัญชี-accounting-firm-sme-2026)
- [AI Chatbot สำนักงานกฎหมาย/ทนายความ — privilege-tagged audit trail + per-matter vault + ฎีกา citation validator](/blog/ai-chatbot-สำนักงานกฎหมาย-ทนายความ-law-firm-sme-2026)
- [AI Chatbot ผู้รับเหมาก่อสร้าง/รีโนเวท — PDPA blueprint vault + site address + เลขบัตร/รายได้ (RBAC ช่างไฟ/ประปา/ปูน) + audit log ม.30](/blog/ai-chatbot-รับเหมาก่อสร้าง-renovation-contractor-sme-2026)
