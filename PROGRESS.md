...
**Detail pages + ChatWidget removal — จบ** — 🟢 `/services/{slug}` × 4 + `/portfolio/{slug}` × 6 + ตัด ChatWidget ตามที่บอสสั่ง
Blockers (FAQ Q10 / Portfolio framing) เคลียร์ตั้งแต่งวดก่อน
**Last deploy:** 2026-04-21 — commit `f6afb53` (detail pages + remove ChatWidget)
**Next immediate:** Gemini image gen ผ่าน Chrome (korpaiix@gmail.com) — gen 10 รูป (4 services + 6 portfolio) → crop ลายน้ำ → แทน Unsplash
