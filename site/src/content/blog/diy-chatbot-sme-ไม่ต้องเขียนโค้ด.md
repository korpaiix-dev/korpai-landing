...
4. **Knowledge Bot (RAG)** — ตอบจากเอกสาร/policy เฉพาะแบรนด์ (ต้องจ้าง — [อ่าน RAG คืออะไร](/blog/rag-คืออะไร))
...
1. **คำถามซ้ำ ๆ ที่ไม่ใช่ FAQ** — ลูกค้าถามอะไรไม่อยู่ใน flow บ่อยขึ้นเรื่อย ๆ → ต้อง RAG (ดู [RAG คืออะไร](/blog/rag-คืออะไร))
